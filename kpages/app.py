...
def _get_opt():
    ...
    parser.add_option("--config", dest = "config", default = 'setting.py',help = "set config for server")
    parser.add_option("--port", dest = "port", default = None, help = "set http port for server")
