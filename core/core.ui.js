...
Kpages.Ui.Paging = Kpages.Ui.Paging ||((function(){
	var paging = function(opts){ this.init(opts)}
...
**/
Kpages.Ui.Dailog = Kpages.Ui.Dailog || ((function(){
    var count = 0;
    var dailog = function(opts){ this.init(opts);}
    dailog.inheritance(Ui.Base,{
        opts:{
            id:false,
            title:'对话框',
            url:false,
        ...
        setContent:function(){
            if(this.opts.url){//加载 url 内容
                var ifr ='<iframe height="100%" frameborder="0" width="100%" src="'+this.opts.url+'" id="_DialogFrame_'+this.count+'" allowtransparency="true" style="border: 0pt none;"></iframe>';
